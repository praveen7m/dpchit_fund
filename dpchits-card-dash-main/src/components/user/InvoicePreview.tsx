...
export const InvoicePreview = ({ data, onClose, onConfirm, isSubmitting }: InvoicePreviewProps) => {
      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            ...
            <CardDescription>Review the invoice details before confirming payment</CardDescription>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                <p><span className="font-medium">Invoice No:</span> {invoiceNo}</p>
                <p><span className="font-medium">Date:</span> {currentDate}</p>
                <p><span className="font-medium">Status:</span> <span className="text-success font-medium">Pending Payment</span></p>
              </div>
            </div>
